...
definition(
    ...
    namespace: "fortrezz",
    author: "FortrezZ, LLC",
    description: "Get a push notification or text message when your sump pump throws an error.",
...
preferences {
	section("When there's water detected...") {
		input "alarm", "capability.sensor", title: "Where?"
	}
...
def alarmHandler(evt) {
	...
	if (alreadySentSms) {
		...
		def msg = "$alarm: ${evt.descriptionText}."
		log.debug "$alarm is ${evt.descriptionText}, texting $phone"
